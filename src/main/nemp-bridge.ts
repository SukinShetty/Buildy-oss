...
const AGENT_ID = 'mybuildy'
const SOURCE = 'mybuildy'
const TAG = 'mybuildy'
...
/** Generate a MYBUILDY.md file from the current memory snapshot. */
export async function exportToMyBuildyMd(filePath: string): Promise<void> {
